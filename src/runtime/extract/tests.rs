...
use super::test_support::{
    derive_expression_label_parameters, fixture_buttons_without_validation, fixture_bytes,
    fixture_images_without_validation, fixture_labels_without_validation, fixture_log,
    fixture_scene, function_expr_has_parameter, function_expr_has_unary,
};
use super::{analyze_scene, build_scene_checked, collect_point_objects};
...
use crate::runtime::scene::{
    ...
    PointIterationFamily, PolygonIterationFamily, ScenePointBinding, ScenePointConstraint,
