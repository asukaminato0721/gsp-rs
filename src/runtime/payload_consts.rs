...
pub(crate) const RECORD_EXPRESSION_ROTATION_MARKER: u32 = 0x232e;
...
pub(crate) const EXPRESSION_TRANSFORM_PARAMETER_ROTATE_CLASS: u16 = 3;
...
pub(crate) const GRAPH_OBJECT_RADIUS_CLASS: u16 = 32;
pub(crate) const GRAPH_OBJECT_CIRCUMFERENCE_CLASS: u16 = 0x0104;
