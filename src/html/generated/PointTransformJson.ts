...
export type PointTransformJson = { "kind": "translate", vectorStartIndex: number, vectorEndIndex: number, } | { "kind": "reflect", lineStartIndex: number, lineEndIndex: number, } | { "kind": "reflect-constraint", line: LineConstraintJson, } | { "kind": "rotate", centerIndex: number, angleDegrees: number, parameterName: string | null, angleExpr: FunctionExprJson | null, angleStartIndex: number | null, angleVertexIndex: number | null, angleEndIndex: number | null, angleParameterPointIndex: number | null, angleParameterStartIndex: number | null, angleParameterEndIndex: number | null, angleParameterScale: number | null, } | { "kind": "scale", centerIndex: number, factor: number, parameterName: string | null, factorExpr: FunctionExprJson | null, };
