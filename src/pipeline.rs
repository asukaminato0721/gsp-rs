...
#[cfg(test)]
mod tests {
    use super::{compile_bytes_to_html_document, compile_bytes_to_scene_json, compile_file_to_html};
    ...
    fn compiles_fixture_and_also_writes_payload_log() {
        ...
        fs::write(&gsp_path, include_bytes!("../tests/fixtures/gsp/static/point.gsp"))
