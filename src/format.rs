...
pub enum GroupKind {
    ...
    Circle,
    CircleCenterRadius,
    LinearIntersectionPoint,
    IntersectionPoint1,
    IntersectionPoint2,
    CircleCircleIntersectionPoint1,
    CircleCircleIntersectionPoint2,
    LineKind5,
    LineKind6,
    LineKind7,
    Polygon,
...
impl From<u16> for GroupKind {
    fn from(value: u16) -> Self {
        match value {
            ...
            9 => Self::LinearIntersectionPoint,
            11 => Self::IntersectionPoint1,
            12 => Self::IntersectionPoint2,
            13 => Self::CircleCircleIntersectionPoint1,
            14 => Self::CircleCircleIntersectionPoint2,
            5 => Self::LineKind5,
            6 => Self::LineKind6,
            7 => Self::LineKind7,
            8 => Self::Polygon,
...
impl GroupKind {
    pub fn raw(self) -> u16 {
        match self {
            ...
            Self::LinearIntersectionPoint => 9,
            Self::IntersectionPoint1 => 11,
            Self::IntersectionPoint2 => 12,
            Self::CircleCircleIntersectionPoint1 => 13,
            Self::CircleCircleIntersectionPoint2 => 14,
            Self::LineKind5 => 5,
            Self::LineKind6 => 6,
            Self::LineKind7 => 7,
            Self::Polygon => 8,
